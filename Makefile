...
MySpace-Linux-Debug:
	 $(PROJECTBUILD) MySpace Linux Debug  -project="$(GAMEPROJECTFILE)" $(ARGS)

MySpace-Linux-DebugGame:
	 $(PROJECTBUILD) MySpace Linux DebugGame  -project="$(GAMEPROJECTFILE)" $(ARGS)

MySpace-Linux-Shipping:
	 $(PROJECTBUILD) MySpace Linux Shipping  -project="$(GAMEPROJECTFILE)" $(ARGS)

MySpace-Linux-Test:
	 $(PROJECTBUILD) MySpace Linux Test  -project="$(GAMEPROJECTFILE)" $(ARGS)

MySpace:
	 $(PROJECTBUILD) MySpace Linux Development  -project="$(GAMEPROJECTFILE)" $(ARGS)

MySpaceEditor-Linux-Debug:
	 $(PROJECTBUILD) MySpaceEditor Linux Debug  -project="$(GAMEPROJECTFILE)" $(ARGS)

MySpaceEditor-Linux-DebugGame:
	 $(PROJECTBUILD) MySpaceEditor Linux DebugGame  -project="$(GAMEPROJECTFILE)" $(ARGS)

MySpaceEditor-Linux-Shipping:
	 $(PROJECTBUILD) MySpaceEditor Linux Shipping  -project="$(GAMEPROJECTFILE)" $(ARGS)

MySpaceEditor-Linux-Test:
	 $(PROJECTBUILD) MySpaceEditor Linux Test  -project="$(GAMEPROJECTFILE)" $(ARGS)

MySpaceEditor:
	 $(PROJECTBUILD) MySpaceEditor Linux Development  -project="$(GAMEPROJECTFILE)" $(ARGS)
