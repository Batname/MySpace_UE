...
MySpaceRootPath=/media/bat/SecondSSD/Projects/Unreal/MySpace

gameProjectFile=/media/bat/SecondSSD/Projects/Unreal/MySpace/MySpace.uproject
build=mono $$unrealRootPath/Engine/Binaries/DotNET/UnrealBuildTool.exe

args=$(ARGS)

include(MySpaceSource.pri)
include(MySpaceHeader.pri)
include(MySpaceConfig.pri)
include(MySpaceIncludes.pri)
include(MySpaceDefines.pri)
...
MySpace-Linux-Debug.commands = $$build MySpace Linux Debug  -project="\"$$gameProjectFile\"" $$args
MySpace-Linux-DebugGame.commands = $$build MySpace Linux DebugGame  -project="\"$$gameProjectFile\"" $$args
MySpace-Linux-Shipping.commands = $$build MySpace Linux Shipping  -project="\"$$gameProjectFile\"" $$args
MySpace-Linux-Test.commands = $$build MySpace Linux Test  -project="\"$$gameProjectFile\"" $$args
MySpace.commands = $$build MySpace Linux Development  -project="\"$$gameProjectFile\"" $$args

MySpaceEditor-Linux-Debug.commands = $$build MySpaceEditor Linux Debug  -project="\"$$gameProjectFile\"" $$args
MySpaceEditor-Linux-DebugGame.commands = $$build MySpaceEditor Linux DebugGame  -project="\"$$gameProjectFile\"" $$args
MySpaceEditor-Linux-Shipping.commands = $$build MySpaceEditor Linux Shipping  -project="\"$$gameProjectFile\"" $$args
MySpaceEditor-Linux-Test.commands = $$build MySpaceEditor Linux Test  -project="\"$$gameProjectFile\"" $$args
MySpaceEditor.commands = $$build MySpaceEditor Linux Development  -project="\"$$gameProjectFile\"" $$args
...
QMAKE_EXTRA_TARGETS += \ 
	...
	MySpace-Linux-Debug \
	MySpace-Linux-DebugGame \
	MySpace-Linux-Shipping \
	MySpace-Linux-Test \
	MySpace \
	MySpaceEditor-Linux-Debug \
	MySpaceEditor-Linux-DebugGame \
	MySpaceEditor-Linux-Shipping \
	MySpaceEditor-Linux-Test \
	MySpaceEditor \
